...
namespace AscNet.Common.MsgPack
{
    ...
    [MessagePackObject(true)]
    public class NotifyHeadPortraitInfos
    {
    ...
    [global::MessagePack.MessagePackObject(true)]
    public class BossSingleChallengeBuffGroupData
    {
        public Int32 BuffGroupId { get; set; }
        public Dictionary<Int32, Int32> BuffChoices { get; set; } = new();
    }
    ...
    public class PreFightRequest
    {
        ...
        public class PreFightRequestPreFightData
        {
            ...
            public BossSingleChallengeBuffGroupData? BossSingleChallengeBuffGroup { get; set; }
        }
